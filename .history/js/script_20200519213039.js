...
function updateHistoryBoard() {
    ...
    <div class="row mt-2">\
        ...
        <div class="col-sm-4" style="text-align:left;" id="content">' + x.content + '</div>\
        <div class="col-sm-1" onclick="removeHistory(' + i + ')"><img class="ml-2" src="img/cross.png" width="25" height="25" style="cursor:pointer;" onclick="()=>confirm("Press a button!");"></div>\
    </div>'
        div.append(html);
    })
}
