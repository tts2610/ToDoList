...
function getLocalStorage() {
    toDoList = JSON.parse(localStorage.getItem("toDoList") || "{isDone:false,content:'Go to CoderSchool'},{isDone:false,content:'Have lunch'},{isDone:false,content:'Go Home'},{isDone:false,content:'Play Game'}");
