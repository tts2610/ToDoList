...
function updateDashboard() {
    ...
    toDoList.forEach((x, i) => {
        let html = '\
    <div class="row">\
        <div class="col"><input class="form-check-input" type="checkbox" value="" id="todo_"' + i + '></div>\
        <div class="col">' + x.content + '</div>\
        <div class="col"><img class="ml-2" src="img/cross.png" width="25" height="25" style="cursor:pointer;"></div>\
    </div>'
        div.append(html);
    })
}