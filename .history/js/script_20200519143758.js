...
function updateDashboard() {
    ...
    toDoList.forEach((x, i) => {
        let html = '\
    <div class="row mt-2">\
        <div class="col-sm"><input class="form-check-input" type="checkbox" name="todo">' + x.content + '</div>\
        <div class="col-sm"><img class="ml-2" src="img/cross.png" width="25" height="25" style="cursor:pointer;"></div>\
    </div>'
        div.append(html);
    })
}
